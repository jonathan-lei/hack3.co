...
const Hero = ({ children, offset }) => (
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        <SVG icon="triangle" hiddenMobile width={48} stroke={colors["blue-light"]} left="10%" top="20%" />
        <SVG icon="hexa" width={48} stroke={colors.purple} left="60%" top="70%" />
        <SVG icon="box" width={6} fill={colors['grey-darker']} left="60%" top="15%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="arrowUp" hiddenMobile width={16} fill={colors['blue-light']} left="80%" top="10%" />
      ...
      <SVG icon="circle" width={64} fill={colors.purple} left="95%" top="5%" />
